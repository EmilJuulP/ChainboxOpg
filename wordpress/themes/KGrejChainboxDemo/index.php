            ...
            <div id="homepage-carousel" class="carousel slide" data-interval="10000" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <a href="/da/products/">
                            <img src="images/demoshop_01.jpg" alt="Hummerbisque med croutoner">
                    ...
                    <div class="item">
                        <a>
                            <img src="images/demoshop_02.jpg" alt="Grillet fisk">
                            <div class="carousel-caption">
                                <h4>Grillet fisk</h4>
                            </div>
                        </a>
                                ...
                                <div>
                                    ...
                                    <form class="newsletter-form has-placeholders" method="post" autocomplete="off">
                                        ...
                                        <p class="text-warning">
                                            <i class="fa fa-fw fa-exclamation-triangle">::before</i>
                                            "Demo mode"
                                        </p>
